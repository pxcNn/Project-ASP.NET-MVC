...
//     Connection String:      `Data Source=PXCNN;Initial Catalog=ShopOnline;Integrated Security=True`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace ShopOnlineConnection
{
    ...
    public partial class LoaiSanPham : ShopOnlineConnectionDB.Record<LoaiSanPham>  
    {
        ...
        [Column] public string TinhTrangLSP { get; set; }
	...
	[PrimaryKey("MaNSS", AutoIncrement=false)]
    ...
    public partial class NhaSanXuat : ShopOnlineConnectionDB.Record<NhaSanXuat>  
    {
		...
		[Column] public string MaNSS { get; set; }

		[Column] public string TenNSS { get; set; }

        [Column] public string TinhTrangNSS { get; set; }
